...
global.owner = [
 ['50376436909', '👑 𝗖𝗿𝗲𝗮𝗱𝗼𝗿 ⚡️', true],
 ['50376436909', '𝗢𝘄𝗻𝗲𝗿 📖', true],
 ['50376436909'],
 ['50376436909'],
 ['50376436909'],
 ['50376436909'],
...
global.comienzo = '• • ◕◕════';
global.fin = '════◕◕ • •';
global.botdate = `*📅 Fecha:*  ${moment.tz('America/El_salvador_City').format('DD/MM/YY')}`;
global.bottime = `*🕒 Hora:* ${moment.tz('America/El_salvador_City').format('HH:mm:ss')}`;
